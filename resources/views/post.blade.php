...
<div class="container">
    <div class="row justify-content-center">
        <div class="col">
                ...
                <p class="mb-4 text-center">By. <a href="#" style="text-decoration:none">{{ $post->user->name }}</a> in <a href="/categories/{{ $post->category->slug }}" style="text-decoration:none">{{ $post->category->name }}</a></p>
